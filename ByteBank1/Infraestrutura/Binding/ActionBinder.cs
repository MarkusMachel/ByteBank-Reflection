...
namespace ByteBank1.Infraestrutura.Binding
{
    public class ActionBinder
    {
        public  ActionBindInfo ObterActionBindInfo(object controller, string path)
        {
            ...
            else
            {
                ...
                var methodInfo = ObterMethodAPartirDeNomeEArgumentos(nomeAction, nomeArgumentos, controller);
        ...
        private MethodInfo ObterMethodAPartirDeNomeEArgumentos(string nomeAction, string[] argumentos, object controller)
        {
